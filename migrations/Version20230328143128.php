 ...
 */
final class Version20230328143128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD user_id INT NOT NULL, ADD office_id INT NOT NULL, ADD invoice_id INT NOT NULL, DROP userid_id, DROP officeid_id, DROP invoiceid_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD userid_id INT NOT NULL, ADD officeid_id INT NOT NULL, ADD invoiceid_id INT NOT NULL, DROP user_id, DROP office_id, DROP invoice_id');
