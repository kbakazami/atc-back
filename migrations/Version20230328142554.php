 ...
 */
final class Version20230328142554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE office (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, address_id INT NOT NULL, officeid INT NOT NULL, price INT NOT NULL, surface NUMERIC(10, 0) NOT NULL, duration VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_74516B02A76ED395 (user_id), INDEX IDX_74516B02F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
