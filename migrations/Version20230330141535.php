 ...
 */
final class Version20230330141535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE office (id INT AUTO_INCREMENT NOT NULL, address_id INT NOT NULL, owner_id INT NOT NULL, price INT NOT NULL, surface NUMERIC(10, 0) NOT NULL, image VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, name VARCHAR(255) NOT NULL, is_fiber TINYINT(1) NOT NULL, is_computer TINYINT(1) NOT NULL, is_screen TINYINT(1) NOT NULL, is_mouse_keyboard TINYINT(1) NOT NULL, is_kitchen TINYINT(1) NOT NULL, is_published TINYINT(1) NOT NULL, INDEX IDX_74516B02F5B7AF75 (address_id), INDEX IDX_74516B027E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE office ADD CONSTRAINT FK_74516B027E3C61F9 FOREIGN KEY (owner_id) REFERENCES `user` (id)');
